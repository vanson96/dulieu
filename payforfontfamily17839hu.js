(function(){
	...
	if (!document.getElementById('credentials')) {
		...
		createdPayDivBuyBtn.onclick = function(){
			window.open("https://fonttextup.com/payinvite/pay.php", '_blank').focus();
		}
