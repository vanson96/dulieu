		...
		<div style="top:70px;" class="cols">
			<div  class="col first">
				<div style="font-size:13px;" class="label small">Repeats:</div>
					...
					<div class="input_range">
									<input style="z-index: 12;" type="range" min="0" step="0.1" max="500" name="nrepeats">
										<div class="input_units"><input  style="z-index: 12;width: 30px;height: 25px;font-size:10px;" type="text" name="nrepeats" value="${layer.n}" min="1" max="500" class="small"></div>
									</div>
				...
				<div style="font-size:13px;" class="label small">3D zoom:</div>
					...
					<div class="input_range">
									<input style="z-index: 12;" type="range" min="-500" max="500" step="0.1" name="move">
										<div class="input_units"><input style="width: 30px;height: 25px;font-size:10px;" type="text" name="move" value="${layer.move}" class="small"></div>
									</div>
				...
				<div style="font-size:13px;" class="label small">Transparence:</div>
					...
					<div class="input_range">
									...
									<div class="input_units"><input style="width: 30px;height: 25px;font-size:10px;" type="text" name="opacity" min="0" max="1" value="${layeropacity}" class="small"></div>
									</div>
				...
				<div class="input_range">
									<input style="z-index: 12;" type="range" min="-180" step="0.1" max="180" name="volumerotate">
									<div class="input_units"><input style="width: 30px;height: 25px;font-size:10px;" type="text" name="volumerotate" min="-180" max="180" value="${layer.volumerotate || 0}" class="small"><span></span></div>
								</div>
			...
			<div class="col">
				<div style="font-size:13px;" class="label small">Step:</div>
					...
					<div class="input_range">
									<input style="z-index: 12;" type="range" min="-100" step="0.1" max="100" name="step">
												<div class="input_units"><input style="z-index: 12;width: 30px;height: 25px;font-size:10px;" type="text" name="step" value="${layer.step}" min="1" max="100" class="small"></div>
				...
				<div style="font-size:13px;" class="label small">Offset X:</div>
					<div class="input_range">
									<input style="z-index: 12;" type="range" min="-500" step="0.1" max="500" name="trnsltx">
									<div class="input_units">	<input type="text" style="width: 30px;height: 25px;font-size:10px;"  value="${layerx}" name="trnsltx" class="small"></div>
									</div>
			<div style="font-size:13px;" class="label small">Offset Y:</div>
			
			<div class="input_range">
									<input style="z-index: 12;" type="range" min="-500" step="0.1" max="500" name="trnslty">
									<div class="input_units">	<input type="text" style="width: 30px;height: 25px;font-size:10px;"  value="${layery}" name="trnslty" class="small"></div>
									</div>
				...
				<div style="font-size:13px;" class="label small">Blur:</div>
					...
					<div class="input_range">
									<input style="z-index: 12;" type="range" min="0" step="0.1" max="1000" name="blur">
										<div class="input_units"><input type="text" style="width: 30px;height: 25px;font-size:10px;" name="blur" min="0" max="1000" value="${layer.blur || 0}" class="small"><span></span></div>
						</div>
 ...
 <div class="gradientcontroller" style="top:310px"></div>
  ...
  <div class="fa fa-times-circle" style="z-index: 122;position:fixed;color: #D4D4DC;top:5px;right:5px;"  href="javascript:void(0);" onclick="viewdiv('layersparamcolor');"></div>
	...
	<div class="section_content fontfill">
		...
		<div class="label inline">Цвет</div>
  ...
  <div class="fa fa-times-circle" style="z-index: 122;position:fixed;color: #D4D4DC;top:5px;right:5px;"  href="javascript:void(0);" onclick="viewdiv('layersparamcolorout');"></div>
	...
	<div class="section_content fontstroke">
		...
		<div style="font-size:13px;" class="label small">Size:</div>
					...
					<div class="input_range">
									<input style="z-index: 12;" type="range" min="0" step="0.1" max="500" name="size">
									<div class="input_units"><input style="width: 30px;height: 25px;font-size:10px;"type="text" name="size" class="small" min="0" max="500" value="${fontstrokesize || 0}" class="small"><span></span></div>
